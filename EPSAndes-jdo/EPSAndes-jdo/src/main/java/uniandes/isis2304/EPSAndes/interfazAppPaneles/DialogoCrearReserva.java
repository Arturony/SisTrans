...
public class DialogoCrearReserva extends JDialog
{
	// -----------------------------------------------------------------
    // Atributos
    // -----------------------------------------------------------------
     ...
     */
    private PanelCrearReserva panelDatos;

    /**
     * Es el panel con los botones para guardar el disco
     */
    private PanelBotonesReserva panelBotones;
     ...
     */
    public DialogoCrearReserva( InterfazEPSAndesApu id )
    {
        super( id, true );
        principal = id;

        panelDatos = new PanelCrearReserva(principal.consultarServiciosNoreservados());
        panelBotones = new PanelBotonesReserva(this);
    ...
    public void crearReserva( )
    {
        ...
        {
        	principal.reservarServicio(s.getServicioSaludID());
        }
        dispose();
    }
}
