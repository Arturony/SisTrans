...
public class PanelBotonesDesreserva extends JPanel implements ActionListener
{
	 // -----------------------------------------------------------------
    // Constantes
    // -----------------------------------------------------------------
     ...
     */
    private static final String DESRESERVAR = "Desreservar";
     ...
     */
    public PanelBotonesDesreserva( DialogoCrearDesreserva dcc )
    {

        ventana = dcc;

        botonAgregarCita = new JButton( "Habilitar" );
        botonAgregarCita.setActionCommand( DESRESERVAR );
    ...
    public void actionPerformed( ActionEvent evento )
    {
        ...
        if( DESRESERVAR.equals( comando ) )
        {
            ventana.crearDesreserva( );
        }
