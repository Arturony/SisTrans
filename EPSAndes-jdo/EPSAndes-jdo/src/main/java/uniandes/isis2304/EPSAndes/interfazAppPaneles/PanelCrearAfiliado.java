...
public class PanelCrearAfiliado extends JPanel implements ActionListener
{
     ...
     */
    public PanelCrearAfiliado( List<EPS> eps )
    {
        ...
        etiquetaFecha = new JLabel( "Fecha Nacimiento: " );
