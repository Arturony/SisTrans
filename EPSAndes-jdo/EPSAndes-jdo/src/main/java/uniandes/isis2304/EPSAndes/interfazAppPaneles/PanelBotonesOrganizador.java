...
public class PanelBotonesOrganizador extends JPanel implements ActionListener
{
	 // -----------------------------------------------------------------
    // Constantes
    // -----------------------------------------------------------------
     ...
     */
    private static final String CREAR_ORGANIZADOR = "CrearOrganizador";
     ...
     */
    private DialogoCrearOrganizador ventana;
     ...
     */
    public PanelBotonesOrganizador( DialogoCrearOrganizador dca )
    {

        ventana = dca;

        botonAgregarAdmin = new JButton( "Crear" );
        botonAgregarAdmin.setActionCommand( CREAR_ORGANIZADOR );
    ...
    public void actionPerformed( ActionEvent evento )
    {
        ...
        if( CREAR_ORGANIZADOR.equals( comando ) )
        {
            ventana.crearOrganizador( );
        }
