...
public class PanelBotonesIPS extends JPanel implements ActionListener
{
	 // -----------------------------------------------------------------
    // Constantes
    // -----------------------------------------------------------------
     ...
     */
    private static final String CREAR_IPS = "CrearIps";
     ...
     */
    private DialogoCrearIPS ventana;
     ...
     * @param dci es una referencia al dialogo que contiene a este panel
     */
    public PanelBotonesIPS( DialogoCrearIPS dci )
    {

        ventana = dci;

        botonAgregarAdmin = new JButton( "Crear" );
        botonAgregarAdmin.setActionCommand( CREAR_IPS );
