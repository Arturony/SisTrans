...
import uniandes.isis2304.parranderos.persistencia.PersistenciaEPSAndes;
...
public class EPSAndes 
{
	...
	public AdministradorD adicionarTipoBebida (String nombre)
	{
        ...
        AdministradorD tipoBebida = pp.adicionarTipoBebida (nombre);		
	...
	public List<AdministradorD> darTiposBebida ()
	{
        ...
        List<AdministradorD> tiposBebida = pp.darTiposBebida ();	
	 ...
	 */
	public List<VOAdministradorD> darVOTiposBebida ()
	{
		log.info ("Generando los VO de Tipos de bebida");        
        List<VOAdministradorD> voTipos = new LinkedList<VOAdministradorD> ();
        for (AdministradorD tb : pp.darTiposBebida ())
        {
        	voTipos.add (tb);
        }
	 ...
	 */
	public AdministradorD darTipoBebidaPorNombre (String nombre)
	{
		log.info ("Buscando Tipo de bebida por nombre: " + nombre);
		List<AdministradorD> tb = pp.darTipoBebidaPorNombre (nombre);
	...
	public Afiliado adicionarBebida (String nombre, long idTipoBebida, int gradoAlcohol)
	{
		...
		Afiliado bebida = pp.adicionarBebida (nombre, idTipoBebida, gradoAlcohol);
	...
	public List<Afiliado> darBebidas ()
	{
        ...
        List<Afiliado> bebidas = pp.darBebidas ();	
	 ...
	 */
	public List<VOAfiliado> darVOBebidas ()
	{
		log.info ("Generando los VO de las bebidas");       
        List<VOAfiliado> voBebidas = new LinkedList<VOAfiliado> ();
        for (Afiliado beb : pp.darBebidas ())
        {
        	voBebidas.add (beb);
        }
	 ...
	 */
	public IPS adicionarBebedor (String nombre, String presupuesto, String ciudad)
	{
        log.info ("Adicionando bebedor: " + nombre);
        IPS bebedor = pp.adicionarBebedor (nombre, presupuesto, ciudad);
	...
	public IPS darBebedorPorId (long idBebedor)
	{
        ...
        IPS bebedor = pp.darBebedorPorId (idBebedor);
	 ...
	 */
	public List<IPS> darBebedoresPorNombre (String nombre)
	{
        log.info ("Dar información de bebedores por nombre: " + nombre);
        List<IPS> bebedores = pp.darBebedoresPorNombre (nombre);
	...
	public List<VOIPS> darVOBebedoresPorNombre (String nombre)
	{
       ...
       for (IPS bdor : pp.darBebedoresPorNombre (nombre))
       {
	...
	public IPS darBebedorCompleto (long idBebedor)
	{
        ...
        IPS bebedor = pp.darBebedorCompleto (idBebedor);
	...
	public List<IPS> darBebedores ()
	{
        ...
        List<IPS> bebedores = pp.darBebedores ();	
	 ...
	 */
	public EPS adicionarBar (String nombre, String presupuesto, String ciudad, int sedes)
	{
        log.info ("Adicionando bar: " + nombre);
        EPS bar = pp.adicionarBar (nombre, presupuesto, ciudad, sedes);
	...
	public Medico adicionarGustan (long idBebedor, long idBebida)
	{
        ...
        Medico resp = pp.adicionarGustan (idBebedor, idBebida);
	...
	public List<Medico> darGustan ()
	{
        ...
        List<Medico> gustan = pp.darGustan ();	
	...
	public Recepcionista adicionarSirven (long idBar, long idBebida, String horario)
	{
        ...
        Recepcionista resp = pp.adicionarSirven (idBar, idBebida, horario);
	...
	public List<Recepcionista> darSirven ()
	{
        ...
        List<Recepcionista> sirven = pp.darSirven ();	
	 ...
	 */
	public List<VORecepcionista> darVOSirven ()
	{
		log.info ("Generando los VO de Sirven");
		List<VORecepcionista> voGustan = new LinkedList<VORecepcionista> ();
		for (VORecepcionista sirven: pp.darSirven ())
		{
			voGustan.add (sirven);
		}
	...
	public Gerente adicionarVisitan (long idBebedor, long idBar, Timestamp fecha, String horario)
	{
        ...
        Gerente resp = pp.adicionarVisitan (idBebedor, idBar, fecha, horario);
	...
	public List<Gerente> darVisitan ()
	{
        ...
        List<Gerente> visitan = pp.darVisitan ();	
