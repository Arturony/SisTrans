...
class SQLServicios 
{
	 ...
	 */
	public List<Gerente> darVisitan (PersistenceManager pm)
	{
	...
	private List<Gerente> darVisitan_V2 (PersistenceManager pm)
	{
		...
		for (Object obj : results)
		{
			...
			resp.add (new Gerente (idBebedor, idBar, fecha, horario));
		}
		return resp;		
	}
