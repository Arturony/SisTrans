...
//			e.printStackTrace();
    	...
    	try
		{
			...
			VOAdministradorD tipoBebida1 = parranderos.adicionarTipoBebida (nombreTipoBebida1);
			...
			VOAdministradorD tipoBebida2 = parranderos.adicionarTipoBebida (nombreTipoBebida2);
			lista = parranderos.darVOTiposBebida();
...
//			e.printStackTrace();
		...
		try
		{
			...
			VOAdministradorD tipoBebida2 = parranderos.adicionarTipoBebida (nombreTipoBebida1);
